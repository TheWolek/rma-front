...
export const collectPackages = "/warehouse/collect";
export const collectPackagesAdd = "/warehouse/collect/add";
export const collectPackagesItems = "/warehouse/collect/items/";
...
export const SparepartsUse = "/warehouse/spareparts/use";
...
export const rmaDictionaryResultTypes = "/rma/dictionary/resultTypes";
